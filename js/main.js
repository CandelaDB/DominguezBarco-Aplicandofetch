            ...
            if (data.results.length == 0) {
                ...
                data.results.forEach(elemento => {
                    ...
                    if (!elemento.image.includes("nopicture.jpg")) {
                        salida += "<div class='col-md-2 mb-2' style='background-image:url(" + elemento.image + "); background-repeat:no-repeat; background-size:cover; background-position:center center; height:480px;' title='" + elemento.title + " " + elemento.description + "'></div>";
